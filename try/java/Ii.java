...
// ****************************************************************************
// File's primary class: Ii
// ****************************************************************************
/** experiment with our ability to create static arrays
 *
 * <ul>
 * <li> Description: 
 *
...
/* ############################################################################
   ...
   */
    ...
    * =======================================================================
    */
   static String[] opcodes= { "copenhagen", "oslo", "stockholm", "rejavik", 
	 "helsinki" };
   ...
   {{
      System.err.println ( "Internal error: "+
	    "unexpected call to default constructor for Ii." );
      System.exit(-127);
   }}
